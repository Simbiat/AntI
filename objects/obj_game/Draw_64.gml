...
draw_set_halign(fa_center);
	draw_text_transformed(room_width/2*global.screen_scale, (room_height - 60)*global.screen_scale, "Lives: "+string(hp), 0.5*global.screen_scale, 0.5*global.screen_scale, 0);