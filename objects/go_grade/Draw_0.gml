...
text_outline(x, y, text, font_color, c_black, 8, 0, image_xscale);
...
if image_xscale == 1 && obj_game.newRecord {
	...
	text_outline(go_total_points.x + stringWidth/2, go_total_points.y - stringHeight/2, "New record", make_colour_rgb(212, 175, 55), c_black, 2);
}
